// arrow functions are priliminary used for functions that don't need a name

export default function () {
  console.log("Hello");
} // this is an annonomous function not in arrow formatt

() => {
  console.log("Hello");
}; // this is an annonomous function in arrow formatt

// you can still pass parameters through an arrow function
(userName, message) => {
